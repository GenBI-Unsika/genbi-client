...
const ActivitiesSection = () => {
  ...
  const gradient = "from-[var(--primary-600)] to-[var(--primary-400)]";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {activities.map((a, i) => (
              <article
                key={i}
                className="group rounded-xl overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow h-full flex flex-col"
              >
                {/* gambar konsisten */}
                <div className="relative w-full aspect-[16/9] bg-gray-100">
                  <img
                    ...
                    loading="lazy"
                    decoding="async"
                    onError={(e) => { e.currentTarget.src = "https://placehold.co/800x450"; }}
                  />
                </div>
                ...
                <div className={`p-4 bg-gradient-to-r ${gradient} text-white rounded-b-xl flex-1 flex flex-col`}> 
                  ...
                  <div>
                    <span className="inline-flex w-fit items-center bg-white/15 text-white text-[11px] leading-none px-2 py-0.5 rounded-full mb-2 border border-white/25">
                      {a.category}
                    </span>
        ...
        <div>
          <div className="flex justify-between items-center mb-8">
            ...
            <a href="#proker" className="text-primary-600 hover:text-primary-700 font-medium">Lihat Semua →</a>
          </div>
