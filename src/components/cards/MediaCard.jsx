...
const MediaCard = ({ title, subtitle, image, category, date, href, gradientClass = 'from-[var(--primary-500)] to-[var(--primary-400)]', subtitleWordsLimit = 10, badge, className = '' }) => {
  ...
  return (
    ...
    >
      ...
      <Wrapper
        {...(href ? { href, 'aria-label': title } : {})}
        className={[`p-4 bg-gradient-to-r ${gradientClass} text-white rounded-b-xl flex-1 flex flex-col`, 'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-300 focus-visible:ring-offset-2'].join(' ')}
      >
        <div>
